...
- **KOSO speedo accuracy** — verify against GPS on a known stretch.
...
- First output shaft bearing replaced
- Piston rings replaced
- Post-accident repairs at M&M Motorcycles / Motorem (€2,968): radiator, fan, thermal switch, exhaust (Arrow), engine guard (Recraft), handlebar, fork repair/straightening, tank cover + painting, engine case cover, footpegs, brake/shift pedals, disassembly/reassembly (8h)

## Maintenance Schedule (Manufacturer)

- Oil + filter: every 6,000 km
- Major service incl. valve clearances: every 12,000 km
- Chain clean/lube/adjust: regularly, especially after unsealed roads
